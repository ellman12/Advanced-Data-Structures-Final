...
foreach(double item in setAsList) Console.Write($"{item} ");
Console.WriteLine();
foreach(double item in setAsArray) Console.Write($"{item} ");
Console.WriteLine();
setAsList.Add(3.14159265);
foreach(double item in setAsList) Console.Write($"{item} ");
Console.WriteLine();

ADS_Final.HashSet<int> hashSet1 = new(new []{1, 2, 3, 4, 5, 6});
ADS_Final.HashSet<int> hashSet2 = new(new []{1, 2, 3, 4, 5, 6});
Console.WriteLine(hashSet1==hashSet2);
Console.WriteLine(hashSet1!=hashSet2);